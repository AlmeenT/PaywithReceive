  ...
  return (
    <div className='flex lg:pb-1 bg-white'>
        <Link to='/'><div className='flex ml-2 mt-4 lg:ml-24 lg:mt-5' >
            ...
            <h2 className='-mt-6 text-xs lg:text-2xl lg:-mt-5  text-orange-400'>re</h2><h2 className='-mt-5 text-xs lg:text-2xl lg:-mt-5 text-blue-800'>ceive</h2>
        </div></Link>
        <div className='links flex ml-14 space-x-4 mt-2 lg:space-x-8 lg:mt-3 lg:ml-80'>

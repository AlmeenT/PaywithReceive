  ...
  return (
    <div className='flex p-1 lg:pb-3 bg-white'>
        <Link to='/'><div className='flex ml-2 mt-4 lg:ml-24 lg:mt-3' >
            ...
            <h2 className='-mt-5 text-xs lg:text-2xl lg:-mt-3  text-orange-400'>re</h2><h2 className='-mt-5 text-xs lg:text-2xl lg:-mt-3 text-blue-800'>ceive</h2>
        </div></Link>
        <div className='links flex ml-14 space-x-4 mt-1 lg:space-x-8 lg:mt-3 lg:ml-80'>
